 ...
 */
package lambdify.aws.events.apigateway;

import java.io.Serializable;
import java.util.Map;

/**
 * Class that represents an ProxyRequestEvent.
 *
 ...
 */
public class ProxyRequestEvent implements Serializable, Cloneable {
     ...
     * @return
     */
    public ProxyRequestEvent withResource(String resource) {
    ...
    /**
     * @param path The url path for the caller
     * @return ProxyRequestEvent object
     */
    public ProxyRequestEvent withPath(String path) {
        this.setPath(path);
        return this;
    }
     ...
     */
    public ProxyRequestEvent withHttpMethod(String httpMethod) {
        this.setHttpMethod(httpMethod);
        return this;
    }
     ...
     * @return ProxyRequestEvent object
     */
    public ProxyRequestEvent withHeaders(Map<String, String> headers) {
     ...
     * @return ProxyRequestEvent
     */
    public ProxyRequestEvent withQueryStringParamters(Map<String, String> queryStringParameters) {
     ...
     * @return ProxyRequestEvent object
     */
    public ProxyRequestEvent withPathParamters(Map<String, String> pathParameters) {
     ...
     * @return ProxyRequestEvent
     */
    public ProxyRequestEvent withStageVariables(Map<String, String> stageVariables) {
     ...
     * @return ProxyRequestEvent object
     */
    public ProxyRequestEvent withRequestContext(ProxyRequestContext requestContext) {
     ...
     * @return ProxyRequestEvent
     */
    public ProxyRequestEvent withBody(String body) {
        this.setBody(body);
        return this;
    }
     ...
     * @return ProxyRequestEvent
     */
    public ProxyRequestEvent withIsBase64Encoded(Boolean isBase64Encoded) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ProxyRequestEvent == false)
            return false;
        ProxyRequestEvent other = (ProxyRequestEvent) obj;
    ...
    @Override
    public ProxyRequestEvent clone() {
        try {
            return (ProxyRequestEvent) super.clone();
        } catch (CloneNotSupportedException e) {
            throw new IllegalStateException("Got a CloneNotSupportedException from Object.clone()", e);
        }
    }
