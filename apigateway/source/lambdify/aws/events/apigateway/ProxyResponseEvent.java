...
/**
 * Class that represents an ProxyResponseEvent object
 */
public class ProxyResponseEvent implements Serializable, Cloneable {
    ...
    /**
     * @param statusCode The HTTP status code for the request
     * @return ProxyResponseEvent object
     */
    public ProxyResponseEvent withStatusCode(Integer statusCode) {
     ...
     */
    public ProxyResponseEvent withHeaders(Map<String, String> headers) {
     ...
     * @return ProxyResponseEvent object
     */
    public ProxyResponseEvent withBody(String body) {
        this.setBody(body);
        return this;
    }
